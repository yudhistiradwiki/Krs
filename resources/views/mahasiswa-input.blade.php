      ...
      <div class="card-body">
        ...
        <form class="forms-sample" action="/mahasiswa/save" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input required type="text" class="form-control" id="nim" value="{{ old('nim') }}" name="nim" placeholder="Nomor Induk Mahasiswa">
        </div>
          <div class="form-group">
            <label for="nama_lengkap">Nama</label>
            <input required type="text" class="form-control" id="nama_lengkap" value="{{ old('nama_lengkap') }}" name="nama_lengkap" placeholder="Nama Lengkap">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input required type="text" class="form-control" id="telepon" name="telepon" value="{{ old('telepon') }}" placeholder="Telepon">
          </div>
          <div class="form-group">
            <label for="tempat_lahir">Tempat Lahir</label>
            <input required type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir') }}" placeholder="Tempat Lahir">
          </div>
          <div class="form-group">
            <label for="tanggal_lahir">Tanggal Lahir</label>
            <input required type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" placeholder="Tempat Lahir">
          </div>
          <div class="form-group">
