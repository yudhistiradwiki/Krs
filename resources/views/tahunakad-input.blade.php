      ...
      <div class="card-body">
        ...
        <form class="forms-sample" action="/tahunakad/save" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input required type="text" class="form-control" id="id_thn_akad" value="{{ old('id_thn_akad') }}" name="id_thn_akad" placeholder="ID">
          </div>
          <div class="form-group">
            <label for="tahun_akademik">Tahun</label>
            <input required type="text" class="form-control" id="tahun_akademik" value="{{ old('tahun_akademik') }}" name="tahun_akademik" placeholder="Tahun Akademik">
          </div>
          <div class="form-group">
